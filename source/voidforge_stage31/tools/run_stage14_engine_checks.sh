...
GODOT_SILENCE_ROOT_WARNING=1 "$GODOT_BIN" --headless --path "$ROOT" res://scenes/tests/stage8_hotbar_smoke_test.tscn
GODOT_SILENCE_ROOT_WARNING=1 "$GODOT_BIN" --headless --path "$ROOT" res://scenes/tests/stage9_grid_smoke_test.tscn
GODOT_SILENCE_ROOT_WARNING=1 "$GODOT_BIN" --headless --path "$ROOT" res://scenes/tests/stage10_block_placement_smoke_test.tscn
GODOT_SILENCE_ROOT_WARNING=1 "$GODOT_BIN" --headless --path "$ROOT" res://scenes/tests/stage11_block_rotation_smoke_test.tscn
GODOT_SILENCE_ROOT_WARNING=1 "$GODOT_BIN" --headless --path "$ROOT" res://scenes/tests/stage12_block_removal_smoke_test.tscn
GODOT_SILENCE_ROOT_WARNING=1 "$GODOT_BIN" --headless --path "$ROOT" res://scenes/tests/stage13_grid_save_load_smoke_test.tscn
GODOT_SILENCE_ROOT_WARNING=1 "$GODOT_BIN" --headless --path "$ROOT" res://scenes/tests/stage14_block_database_smoke_test.tscn
